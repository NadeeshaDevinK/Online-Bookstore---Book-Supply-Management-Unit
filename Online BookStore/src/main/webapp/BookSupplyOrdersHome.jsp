...
<div class="logo">
  ...
  <ul class="nav">
    <li ><a id="active" href="#">Supply Management</a></li>
...
<div class="fulDiv">
	<div class="leftDiv">
		<div class="centerDiv">
		    <h2 style="text-align: center; color:#3d404e;">Supply Management</h2> <br>
		<a href="AdminLogin.jsp">
				<input type="button" value="AdminLogin" class="linkbutton">
		</a>
		<a href="PublisherLogin.jsp">
				<input type="button" value="Publisher Login" class="linkbutton">
		</a>
		</div>
	</div>
	<div class="rightDiv">
		<img src="images/orderhome.png" alt="inquiry" width="700" height="700" class="center" >
	</div>
</div>
<!-- Page Body section -->
<!-- Footer -->
