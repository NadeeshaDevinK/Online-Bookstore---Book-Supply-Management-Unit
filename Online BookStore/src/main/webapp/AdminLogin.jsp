...
<div class="page-wrapper" >
	...
	<!-- set database objects to the variables -->
		...
		<form action="AdminLogin"  method="post"  onsubmit="return checkID()">
		<!-- User Email -->
		<div class="row">
			...
			<div class="col-75" style="width: 75%;">
				<input type="email" id="userEmail" name="userEmail" placeholder="Enter Your UserEmail">
			</div>
		</div>
		<br>
		<!-- User Email -->
		...
		<div class="row">
			...
			<div class="col-75" style="width:75%;">
				<input type="password" id="userPwd" name="userPwd" placeholder="Enter Your UserPassword">
			</div>
		</div>
		<br>
		<!-- user Password -->
